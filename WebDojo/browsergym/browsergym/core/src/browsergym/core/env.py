...
from .webrl_utils.webrl_utils import get_parsed_html
    ...
    def _get_obs(self):
        ...
        for retries_left in reversed(range(EXTRACT_OBS_MAX_TRIES)):
            try:
                ...
                # TODO: add webrl html representation
                parsed_html = get_parsed_html(self.page)
                
                dom = extract_dom_snapshot(self.page)
                dom["html"] = copy.deepcopy(parsed_html)
